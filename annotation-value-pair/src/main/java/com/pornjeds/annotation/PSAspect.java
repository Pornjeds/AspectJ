...
public class PSAspect {
    ...
    public void annotationPointCutDefinition(PSAnnotation yourAnnotationVariableName){
    }
    ...
    public Object aroundAdvice(ProceedingJoinPoint joinPoint, PSAnnotation yourAnnotationVariableName) throws Throwable {
    ...
    public void printNewLine(JoinPoint pointcut, PSAnnotation yourAnnotationVariableName){
